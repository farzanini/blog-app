              ...
              <div className="flex h-full w-full flex-col overflow-scroll px-6 ">
                ...
                <div>
                  <form
                    ...
                    className="my-6 flex flex-col items-end space-y-4 p-5"
                  >
                    <textarea
                      id="comment"
                      rows={3}
                    ...
                    {isValid && (
                      <button
                        type="submit"
                        className="flex items-center space-x-3 rounded border border-gray-300 px-4  py-2.5 transition hover:border-gray-900 hover:text-gray-900"
                      >
                        Comment
                      </button>
                    )}
                  ...
                  <div className="flex flex-col items-center justify-center space-y-6">
                    {getComments.isSuccess &&
                      getComments.data.map((comment) => (
                        <div
                          className="flex w-full flex-col space-y-2 border-b border-b-gray-500 pb-4 last:border-none"
                          key={comment.id}
                        >
