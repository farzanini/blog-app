    ...
    <Modal isOpen={isOpen} onClose={() => onClose} title="Create a tag">
      ...
      >
        ...
        <div className="flex w-full justify-end">
          <button
            className="w-fit space-x-3 whitespace-nowrap rounded border border-gray-200 px-4 py-2.5 text-right  text-sm transition hover:border-gray-900 hover:text-gray-900"
            type="submit"
          >
            Create
          </button>
